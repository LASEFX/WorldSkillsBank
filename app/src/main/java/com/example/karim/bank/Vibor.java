...
public class Vibor extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =   inflater.inflate(R.layout.fragment_vibor, container, false);

        oplatit = view.findViewById(R.id.oplatit);
        oplatit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                btn_positive.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        dialog.cancel();
                        getFragmentManager().beginTransaction().replace(R.id.frame, new ViborPoluch()).commit();
                    }
                });
                ...
                btn_negative.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Toast.makeText(getActivity(),
                                "Вы не подтвердили", Toast.LENGTH_SHORT).show();
                    }
                });
